...
AgentStart owns the authenticated fleet MCP gateway and its Tailscale Funnel
route. The machine installer delegates that setup to AgentStart; Funk owns
Tailscale availability and preserves the gateway and unrelated Funnel routes.
See `~/code/agentstart/gateway/README.md` for toolsets and client configuration.
